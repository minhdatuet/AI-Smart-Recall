 ...
 class JsonArray : List<object>
    {
        ...
        {
            return YoSimpleJson.SerializeObject(this) ?? string.Empty;
        }
    }
 ...
 IDictionary<string, object>
    {
        ...
        public override string ToString()
        {
            return YoSimpleJson.SerializeObject(_members);
        }
 ...
 static class YoSimpleJson
    {
        ...
        static bool SerializeNumber(object number, StringBuilder builder)
        {
            ...
            else if (number is Enum)
                builder.Append(number.GetHashCode());
 ...
 class PocoJsonSerializerStrategy : IJsonSerializerStrategy
    {
        ...
        public virtual object DeserializeObject(object value, Type type)
        {
            ...
            if (nullableType != null && YoSimpleJson.NumberTypes.IndexOf(nullableType) != -1)
                type = nullableType; // Just use the regular type for the conversion
            bool isNumberType = YoSimpleJson.NumberTypes.IndexOf(type) != -1;
